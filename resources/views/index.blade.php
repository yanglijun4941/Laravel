...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="http://www.lv.com/admin/index/adminlist" data-title="管理员管理" href="javascript:void(0)">资讯管理</a></li>
			</ul>
		</dd>
	</dl>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="管理员管理" data-href="http://www.lv.com/admin/index/adminlist">管理员管理</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="http://www.lv.com/admin/index/adminlist"></iframe>
	</div>
</div>
</section>
